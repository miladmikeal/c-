 ...
 * to necessary values. Also seeds srand().
****************************************************************/
...
int HarryPotter::attack() {
    ...
    cout << "Harry Potter attacked. " << damage << " damage points "
         << "generated." << endl;
    // Return damage
    return damage;
}
...
void HarryPotter::defense(int d) {
    ...
    if (d != 1000) {
        cout << "Harry Potter generated " << defense
             << " defense points." << endl
             << "Armor: " << getArmor() << endl;
        // Calculate damage
        damage = d - defense;
        ...
        if (damage <= 0) {
            // No damage taken
            cout << "Harry Potter's defense prevails. "
                 << "0 damage taken." << endl
                 << "Harry Potter's remaining strength: "
                 << getStrength() << endl;
        } else if (damage > 0) {
            // Factor in damage
            ...
            if (getStrength() > 0) {
                cout << "Harry Potter has been damaged " << damage
            ...
            // If not strength points remaining, but still have special
                ...
                cout << "Harry Potter uses his Hogwarts special ability." << endl
    ...
    // If Harry turned to stone by Medusa
        ...
        if (hogwarts == 1) {
            // Die
            cout << "Harry Potter looked into Medusa's eyes and died!" << endl;
